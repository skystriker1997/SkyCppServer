...
Socket::Socket(std::unique_ptr<InetAddress> addr) : addr_(std::move(addr)), logger_(Logger::log_level::debug, Logger::log_target::file_and_terminal, log_path) {
...
Socket::Socket() : logger_(Logger::log_level::debug, Logger::log_target::file_and_terminal, log_path) {
